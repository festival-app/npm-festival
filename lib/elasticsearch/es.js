...
module.exports.es = function es(client) {
  ...
  const exists = function exists(id, esConfig, callback) {
  ...
  const create = function create(id, body, esConfig, callback) {
  ...
  const update = function update(id, body, esConfig, callback) {
  ...
  const get = function get(id, esConfig, callback) {
  ...
  const remove = function remove(id, esConfig, callback) {
  ...
  const save = function save(id, body, callback) {
  ...
  const search = function search(body, esConfig, callback) {
