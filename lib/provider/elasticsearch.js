...
var createFestival = function (newFestival, callback) {
  ...
  elasticsearch.create(festivalId, newFestival, config.elasticsearch.festivals, function (error, result) {
...
var getFestival = function (festivalId, callback) {
  ...
  elasticsearch.get(festivalId, config.elasticsearch.festivals, function (error, result) {
...
var getFestivals = function (searchFestivalsRequest, callback) {
  ...
  elasticsearch.search(body, config.elasticsearch.festivals, function (error, result) {
...
var createFestivalPlace = function (festivalId, newPlace, callback) {
  ...
  elasticsearch.create(id, newPlace, config.elasticsearch.place, function (error, result) {
...
var createFestivalEvent = function (festivalId, newEvent, callback) {
  ...
  getFestival(festivalId, function (err, festival) {
    ...
    elasticsearch.create(id, newEvent, config.elasticsearch.events, function (error, result) {
...
var getFestivalEvents = function (festivalId, searchFestivalEventsRequest, callback) {
  ...
  elasticsearch.search(body, config.elasticsearch.events, function (error, result) {
...
var getFestivalEvent = function (festivalId, eventId, callback) {
  ...
  elasticsearch.get(eventId, config.elasticsearch.events, function (error, result) {
    if (!result) {
