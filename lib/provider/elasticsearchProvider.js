...
module.exports.provider = function provider(es) {
  ...
  var getFestivals = function getFestivals(searchFestivalsRequest, callback) {
    ...
    es.search(getElasticSearchFilters(searchFestivalsRequest), config.elasticsearch.festivals, function (error, result) {
      if (error) {
        logger.warn(error);
  ...
  var getFestivalEvents = function getFestivalEvents(festivalId, searchFestivalEventsRequest, callback) {
    ...
    getFestival(festivalId, function (err, festival) {
      ...
      searchFestivalEventsRequest.festival = festivalId;

      es.search(getElasticSearchFilters(searchFestivalEventsRequest), config.elasticsearch.events, function (error, result) {
        if (error) {
          logger.warn(error);
  ...
  var getFestivalPlaces = function getFestivalPlaces(festivalId, searchFestivalPlacesRequest, callback) {
    ...
    getFestival(festivalId, function (err, festival) {
      ...
      searchFestivalPlacesRequest.festival = festivalId;

      es.search(getElasticSearchFilters(searchFestivalPlacesRequest), config.elasticsearch.places, function (error, result) {
  ...
  var getFestivalCategories = function getFestivalCategories(festivalId, searchFestivalCategoriesRequest, callback) {
    ...
    getFestival(festivalId, function (err, festival) {
      ...
      searchFestivalCategoriesRequest.festival = festivalId;

      es.search(getElasticSearchFilters(searchFestivalCategoriesRequest), config.elasticsearch.categories, function (error, result) {
