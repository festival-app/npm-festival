...
module.exports.provider = function provider(es) {
  ...
  var getEventsSearchParams = function getEventsSearchParams(festivalId, searchFestivalEventsRequest) {
    var searchData = {
      query: {
        filtered: {
          query: {
            match: { festival: festivalId }
          }
          //filter: filter
        }
      }
    ...
    if (searchFestivalEventsRequest.limit > 0) {
      searchData.size = searchFestivalEventsRequest.limit;
    }

    if (searchFestivalEventsRequest.offset > 0) {
      searchData.from = searchFestivalEventsRequest.offset;
    }
  ...
  var getFestivalEvents = function getFestivalEvents(festivalId, searchFestivalEventsRequest, callback) {
    ...
    getFestival(festivalId, function (err, festival) {
      ...
      es.search(getEventsSearchParams(festivalId, searchFestivalEventsRequest), config.elasticsearch.events, function (error, result) {
  ...
  var getPlacesSearchParams = function getPlacesSearchParams(festivalId, searchFestivalPlacesRequest) {
    var searchData = {
      query: {
        filtered: {
          query: {
    ...
    if (searchFestivalPlacesRequest.limit > 0) {
      searchData.size = searchFestivalPlacesRequest.limit;
    }

    if (searchFestivalPlacesRequest.offset > 0) {
      searchData.from = searchFestivalPlacesRequest.offset;
    }
  ...
  var getFestivalPlaces = function getFestivalPlaces(festivalId, searchFestivalPlacesRequest, callback) {
    ...
    getFestival(festivalId, function (err, festival) {
      ...
      es.search(getPlacesSearchParams(festivalId, searchFestivalPlacesRequest), config.elasticsearch.places, function (error, result) {
  ...
  var getCategoriesSearchParams = function getCategoriesSearchParams(festivalId, searchFestivalCategoriesRequest) {
    var searchData = {
      query: {
        filtered: {
          query: {
    ...
    if (searchFestivalCategoriesRequest.limit > 0) {
      searchData.size = searchFestivalCategoriesRequest.limit;
    }

    if (searchFestivalCategoriesRequest.offset > 0) {
      searchData.from = searchFestivalCategoriesRequest.offset;
    }
  ...
  var getFestivalCategories = function getFestivalCategories(festivalId, searchFestivalCategoriesRequest, callback) {
    ...
    getFestival(festivalId, function (err, festival) {
      ...
      es.search(getCategoriesSearchParams(festivalId, searchFestivalCategoriesRequest), config.elasticsearch.categories, function (error, result) {
