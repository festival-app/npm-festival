...
module.exports.provider = function provider(myRootRef) {
  const _festivalsRef = myRootRef.child('festivals');
  const _festivalsEventsRef = myRootRef.child('festivals-events');
  const _festivalsPlacesRef = myRootRef.child('festivals-places');
  const _festivalsCategoriesRef = myRootRef.child('festivals-categories');
