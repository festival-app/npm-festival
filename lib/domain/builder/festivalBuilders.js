...
var buildFestivalDomain = function buildFestivalDomain(params, newObject, user) {
  ...
  var status = validate.getEnum(FestivalStatusEnum.getStatus(params.status), 'status', FestivalStatusEnum.CREATED);
