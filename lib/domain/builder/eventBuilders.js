...
var buildEventResponse = function buildEventResponse(data, placeData, categoryData) {
  if (!data) {
    return null;
  }
  ...
  var eventPlace = buildEventPlaceResponse(placeData);
  var eventCategory = buildEventCategoryResponse(categoryData);
