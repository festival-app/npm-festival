...
var createFestivalCategory = function createFestivalCategory(festivalId, newCategory, options, callback) {
  ...
  try {
    provider.createFestivalCategory(festivalId, newCategory, function (err, category) {
      ...
      if (err) {
        logger.debug('createFestivalCategory: Unable to create festival category: ', festivalId, newCategory, err);
        return callback(err);
      }
    ...
    logger.warn('createFestivalCategory: unable to create festival: ', e);
    return callback(e);
  }
};
...
var updateFestivalCategory = function updateFestivalCategory(festivalId, categoryId, newCategory, options, callback) {
  ...
  try {
    provider.updateFestivalCategory(festivalId, categoryId, newCategory, function (err, festival) {
      ...
      if (err) {
        logger.debug('updateFestivalCategory: Unable to update festival category: ', newCategory, err);
        return callback(err);
      }
    ...
    logger.warn('updateFestivalCategory: unable to update festival category: ', e);
    return callback(e);
  }
};
...
var getFestivalCategory = function getFestivalCategory(festivalId, categoryId, options, callback) {
  ...
  try {
    provider.getFestivalCategory(festivalId, categoryId, function (err, category) {
      ...
      if (err) {
        logger.debug('getFestivalCategory: Unable to get festival category: ', err);
        return callback(err);
      }
    ...
    logger.warn('getFestivalCategory: unable to get festival category for id: ', festivalId, categoryId, e);
    return callback(e);
  }
};

var getFestivalCategories = function getFestivalCategories(id, searchFestivalCategoriesRequest, options, callback) {
  logger.debug('getFestivalCategories: ', id, searchFestivalCategoriesRequest);

  try {
    provider.getFestivalCategories(id, searchFestivalCategoriesRequest, function (err, festivalCategories) {

      if (err) {
        logger.debug('getFestivalCategories: Unable to get festival categories: ', err);
        return callback(err);
      }
    ...
    logger.warn('getFestivalCategories: unable to get festival categories for: ', id, searchFestivalCategoriesRequest, e);
    return callback(e);
  }
};
