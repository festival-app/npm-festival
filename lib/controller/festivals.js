...
var createFestivalV1 = function createFestivalV1(req, res, next) {
  ...
  return festivals.createFestival(festival, {}, function (err/*, result*/) {
    if (err) {
...
var updateFestivalV1 = function updateFestivalV1(req, res, next) {
  ...
  return festivals.getFestival(id, options, function (err, festival) {
    if (err) {
    ...
    return festivals.updateFestival(id, newFestival, {}, function (errFestival/*, result*/) {
      if (errFestival) {
...
var deleteFestivalV1 = function deleteFestivalV1(req, res, next) {
  ...
  return festivals.getFestival(id, options, function (err, festival) {
    ...
    return festivals.deleteFestival(id, options, function (errFestival/*, result*/) {
      if (errFestival) {
