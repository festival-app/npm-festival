...
var createNewsV1 = function createNewsV1(req, res, next) {
  ...
  festivals.createNews(news, {}, function (err/*, result*/) {
    if (err) {
...
var getNewsV1 = function getNewsV1(req, res, next) {
  ...
  festivals.getNews(newsId, {}, function (err, news) {
    if (err) {
...
var updateNewsV1 = function updateNewsV1(req, res, next) {
  ...
  festivals.getNews(newsId, {}, function (err, news) {
    ...
    festivals.updateNews(newsId, newNews, {}, function (errNews/*, result*/) {
      if (errNews) {
...
var deleteNewsV1 = function deleteNewsV1(req, res, next) {
  ...
  festivals.getNews(newsId, {}, function (err, news) {
    ...
    festivals.deleteNews(newsId, {}, function (errNews/*, result*/) {
      if (errNews) {
