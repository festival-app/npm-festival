...
var createFestivalEventV1 = function createFestivalEventV1(req, res, next) {
  ...
  return festivals.createFestivalEvent(id, event, {}, function (err/*, result*/) {
    if (err) {
...
var updateFestivalEventV1 = function updateFestivalEventV1(req, res, next) {
  ...
  return festivals.getFestivalEvent(id, eid, {}, function (err, event) {
    if (err) {
    ...
    return festivals.updateFestivalEvent(id, eid, newEvent, {}, function (errEvent/*, result*/) {
      if (errEvent) {
...
var getFestivalEventsV1 = function getFestivalEventsV1(req, res, next) {
  ...
  return festivals.getFestivalEvents(id, search, {}, function (err, data) {
...
var deleteFestivalEventV1 = function deleteFestivalEventV1(req, res, next) {
  ...
  return festivals.getFestivalEvent(id, eid, {}, function (err, event) {
    ...
    return festivals.deleteFestivalEvent(id, eid, {}, function (errEvent/*, result*/) {
      if (errEvent) {
