...
var updateFestivalCategoryV1 = function updateFestivalCategoryV1(req, res, next) {
  ...
  festivals.getFestivalCategory(id, cid, {}, function (err, data) {
    if (err) {
    ...
    category = categoryBuilders.buildCategoryDomain(id, data, false);
...
var deleteFestivalCategoryV1 = function deleteFestivalCategoryV1(req, res, next) {
  ...
  festivals.deleteFestivalCategory(id, cid, {}, function (err, result) {
    if (err) {
      keen.errorCategory('delete', req.authorization.bearer, req.params, err);
    }
    next.ifError(err);
