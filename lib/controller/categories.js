...
var createFestivalCategoryV1 = function createFestivalCategoryV1(req, res, next) {
  ...
  return festivals.createFestivalCategory(id, category, {}, function (err/*, result*/) {
    if (err) {
...
var updateFestivalCategoryV1 = function updateFestivalCategoryV1(req, res, next) {
  ...
  return festivals.getFestivalCategory(id, cid, {}, function (err, category) {
    ...
    return festivals.updateFestivalCategory(id, cid, newCategory, {}, function (errCategory/*, result*/) {
      if (errCategory) {
...
var getFestivalCategoriesV1 = function getFestivalCategoriesV1(req, res, next) {
  ...
  return festivals.getFestivalCategories(id, search, {}, function (err, data) {
    if (err) {
...
var deleteFestivalCategoryV1 = function deleteFestivalCategoryV1(req, res, next) {
  ...
  return festivals.getFestivalCategory(id, cid, {}, function (err, category) {
    ...
    return festivals.deleteFestivalCategory(id, cid, {}, function (errCategory/*, result*/) {
      if (errCategory) {
